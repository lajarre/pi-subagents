...
User and project agent definitions may be regular `.md` files or symlinked
`.md` files. Symlinks are loaded like normal agent definitions, which makes
it easy to keep `.pi/agents/` as a thin pointer layer to another source of
truth.
